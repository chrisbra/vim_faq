...
=head1 VARIOUS
 ...
 36.11. Why shouldn't I modify the files in the system runtime
        directory?
 36.12. How do I debug and find out if there is an error in my .vimrc
...
The Vim Development mailing list (see Question 2.2) is a good
place to discuss general bugs.  If the bug you find is with syntax
highlighting or some other "added feature" (i.e. not directly programmed
into vim), attempt to inform the maintainer of that feature.
...
few as possible 'a's without trying to keep going until Vim finds the
...
=head2 36.12. How do I debug and find out if there is an error in my .vimrc or
